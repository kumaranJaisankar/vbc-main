...
import { Row, Col, Container, Form, Label, Input, FormGroup, Button } from "reactstrap";
                  ...
                  <FormGroup>
                    <div className="input_wrap">
                      ...
                      className={`form-control-digits not-empty`}
                       type="select" name="status" value={inputs.status} onChange={handleChange}>
                ...
                <Col md="3">
                  <FormGroup>
                    <div className="input_wrap">
                      ...
                      <Label hidden={inputs.bouquetType === "0"} className="placeholder_styling">
                        Broadcaster
                      </Label>
                    </div>
                  </FormGroup>
              ...
              <Col md="12">
                  <FormGroup>
                    <Label>Channels</Label>
                      <ChannelDropDown treeData={categories} setChannels={setChannels}/>
                  </FormGroup>
                </Col>
              </Row>
