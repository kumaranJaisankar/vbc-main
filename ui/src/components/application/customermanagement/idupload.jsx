...
useEffect(() => {
  setImageUploadAadh(props.formData.customer_documents.identity_proof);
}, []);
       ...
       <div>
        ...
        <FormIconComponent
          handleClearImageClick={(e) => {
            setImgSrcAadh(null);
            setImageUploadAadh(null);
          }}
          iconName={imageUploadAadh ? "idProofUpload" : "addIdentityProof"}
          textBelowIcon={"Add identity proof"}
          onClick={Verticalcentermodaltoggle}
          imageData={imageUploadAadh ? imageUploadAadh : null}
          alt={"Aadhar"}
        />
       </div>
