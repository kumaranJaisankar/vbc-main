...
//         name: 'ID',
//         // selector: row => 
//         // <Link to={`${process.env.PUBLIC_URL}/app/leads/leaddetails/${row.id}/vbc`}>
//         // L00{row.id}
//         // </Link>,
//         selector: "id",
//         cell: row => 
//         <a href="#" 
//         // {`${process.env.PUBLIC_URL}/app/leads/leaddetails/${row.id}/spark_radius`}   
//         >
//         L00{row.id}
//         </a>,
//         sortable: true,
...
//         sortable: true,
//         cell: row =>  `${row.house_no},${row.street},${row.area},${row.district},${row.pin_code}`
//     },
//     {
//         name: 'Priority',
//         selector: 'priority',
