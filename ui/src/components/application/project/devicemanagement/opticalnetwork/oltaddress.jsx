      ...
      <Row>
        <Col sm="4">
          <FormGroup>
            <div className="input_wrap">
              <Input
                className={`form-control ${props.formData && props.formData.house_no ? 'not-empty' :''}`}
                type="text"
                name="house_no"
        ...
        <Col sm="4">
          <FormGroup>
            <div className="input_wrap">
              <Input
               className={`form-control ${props.formData && props.formData.street ? 'not-empty' :''}`}
                type="text"
                name="street"
                onChange={props.handleInputChange}
                onBlur={props.checkEmptyValue}
        ...
        {/* <Col sm="4">
          <FormGroup>
            ...
            <span className="errortext">{props.errors.street && 'Please Select Street'}</span>
        ...
        <Col sm="4">
          <FormGroup>
            <div className="input_wrap">
              <Input
               className={`form-control ${props.formData && props.formData.pincode ? 'not-empty' :''}`}
                type="text"
                name="pincode"
                placeholder="Pincode *"
      ...
      <Row>
        ...
        <Col sm="4">
          <FormGroup>
            <div className="input_wrap">
              <Input
                 className={`form-control ${props.formData && props.formData.state ? 'not-empty' :''}`}
                type="text"
                name="state"
                placeholder="State *"
        ...
        <Col sm="4">
          <FormGroup>
            <div className="input_wrap">
              <Input
                 className={`form-control ${props.formData && props.formData.country ? 'not-empty' :''}`}
                type="text"
                name="country"
                onChange={props.handleInputChange}
        ...
        <Col sm="4">
                <FormGroup>
                  <div className="input_wrap">
                    <Input
                      style={{ color: "#495057" }}
                      className={`form-control ${props.formData && props.formData.latitude ? 'not-empty' :''}`}
                      type="text"
                      name="latitude"
                      onChange={props.handleInputChange}
                      onBlur={props.checkEmptyValue}
              ...
              <Col sm="4">
                  <FormGroup>
                    <div className="input_wrap">
                      <Input
                        style={{ color: "#495057" }}
                        className={`form-control ${props.formData && props.formData.longitude ? 'not-empty' :''}`}
                        type="text"
                        name="longitude"
                        onChange={props.handleInputChange}
                        onBlur={props.checkEmptyValue}
